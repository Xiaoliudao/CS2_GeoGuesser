...
CS2 Map Guesser 是一个支持 2–5 人的实时 Counter-Strike 2 地图位置竞猜游戏。

玩家会看到一张真实的 CS2 游戏截图，需要先判断地图和楼层，再在 2D radar 上标出截图对应的位置。所有玩家根据地图判断、位置准确度和答题速度获得分数。
...
2. 2–5 名玩家进入房间并点击 Ready，由房主开始比赛。
