/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 68f8840bdec43e85367d4afc06886f27)
...
interface __BaseEnv_Env {
	...
	ASSETS: Fetcher;
	PUBLIC_APP_ORIGIN: "https://cs2-map-guesser.457214526y.workers.dev";
	PUBLIC_ASSET_ORIGIN: "";
	GAME_ROOM: DurableObjectNamespace<import("./src/worker/index").GameRoom>;
	SOLO_SESSION: DurableObjectNamespace<import("./src/worker/index").SoloSession>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "GameRoom" | "SoloSession";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_APP_ORIGIN" | "PUBLIC_ASSET_ORIGIN">> {}
}
